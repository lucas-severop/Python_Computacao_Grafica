...
def inicializaObjetos():
    ...
    points = [
            ...
            0.0, 0.0, 0.0, #cima
		    0.25, -0.5, 0.0, #direita
		    -0.25, -0.5, 0.0, #esquerda
            ...
            -0.37, -0.5, 0.0, #cima
		    -0.12, 0.0, 0.0, #direita
		    -0.62, 0.0, 0.0, #esquerda
    ]
...
def inicializaObjetos3():
    ...
    points3 = [
         ...
         0.25,  0.75, 0.0,   # vértice superior direito
         0.25, 0.25, 0.0,   # vértice inferior direito
         -0.25, 0.25, 0.0,   # vértice inferior esquerdo

         -0.25,  0.75, 0.0,       # vértice superior esquerdo
         0.25,  0.75, 0.0,       # vértice superior direito
         -0.25, 0.25, 0.0        # vértice inferior esquerdo
...
def inicializaRenderizacao():
    global Window, Shader_programm, Vao,Vao2, Vao3, WIDTH, HEIGHT
